...
// solve for Advection-Diffusion equation
//
// methods:   EQS_KD2D::coefs()
//            EQS_KD2D::region()   two-dimensional region elements (quadratic)
//            EQS_KD2D::regionL()  two-dimensional region elements (linear)
//
